...
namespace AILogisticsAutomation
{
    ...
    public class AIDisplayMonitorSettings : IAIBlockSettings<AIDisplayMonitorSettingsData>
    {
        ...
        public AIDisplayMonitorSettingsData GetData()
        {
            var data = new AIDisplayMonitorSettingsData
            {
        ...
        public void UpdateData(AIDisplayMonitorSettingsData data)
        {
